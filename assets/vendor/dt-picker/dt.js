  ...
  return function () {
    ...
    class T {
      ...
      static getDaysDates(e, t) {
        let {viewDate: i, locale: {firstDay: s}} = e, a = h(i), {year: n, month: r} = o(i), l = new Date(n, r, 1),
          d = new Date(n, r, a), c = l.getDay() - s, u = 6 - d.getDay() + s;
      ...
      constructor(e, t) {
        ...
        if (I(this, "viewIndexes", [i.days, i.months, i.years]), I(this, "next", (() => {
          ...
          let i, s, {isMobile: a} = r.opts, n = r.$el.getBoundingClientRect(), h = r.$el.getBoundingClientRect(),
            ...
            c = e.split(" "), u = window.scrollY, p = window.scrollX, m = r.opts.offset, v = c[0], g = c[1];
